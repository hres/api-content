...
namespace regContentWebApi.Controllers
{
    public class HomeController : GoC.WebTemplate.WebTemplateBaseController
    {
        ...
        {
            // Page Title
            this.WebTemplateCore.HeaderTitle = "Regulatory Content";
            ...
            this.WebTemplateCore.Breadcrumbs.Add(new Breadcrumb("", "Regulatory Content", ""));
            ...
            // Date Modified
            this.WebTemplateCore.DateModified = Convert.ToDateTime("2016-07-21");
